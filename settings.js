...
global.alivemsg = `📤~_*🙏山モㄥ匚口爪モ*🙏_~

*💯බොට් ඔන්ලයින් පවති💯*

_*🇱🇰∂αяк иєяσ м∂ вσт🇱🇰*_

_*💦මෙය ස්වයංක්‍රීයව ක්‍රියාත්මක වන вσт gяσυρ එකකි.💦*_
▬▬▬▬▬●🅡︎🅤︎🅛︎🅔︎🅢︎●▬▬▬▬▬

*🫧මෙහි සිටින බොට් වැඩද බැලීමට _. Ѧℓїṽ℮_ යන කමාන්ඩ් එක බාවිතා කරන්න.*

*🫧බොට්ගේ ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ එක ගැනීම සදහා _. м℮ηʊ_  බාවිතා කරන්න..*

*🫧මෙයින් ඔබට අවශ්‍ය _ѕσng, vídєσѕ, phσtσѕ_ සහ තවත් දේ ලබා ගත හැක.*

*🫧කමාන්ඩ් යෙදීමේදී මුලට තිත අත්‍යාවශ්‍ය වේ!*

*උදා -: .ѕσng නාදෙන්*

▬▬▬▬▬●R̺U̺L̺E̺S̺●▬▬▬▬▬

*❌වෙන gяσυρ වල ලින්ක් දාන්න එපා.*

*❌ѕραм ගහන්න එපා.*

*❌gяσυρ එක яєρσят කරන්න එපා.* 

*❌එක ¢σммαи∂ එක නැවත නැවත බාවිතා කරන්න එපා.*

*❌ඇඩ්මින්ගෙ ιивσχ එන්න එපා.*
𝔾ℝ𝕆𝕌ℙ ලින්ක් එක මෙන්න ඔයාලගේ යාලුවොත් ඇඩ් කරගන්න 𝚂𝙷𝙰𝙸𝚁 කරන්න💦
<𝔾ℝ𝕆𝕌ℙ 𝕃𝕀ℕ𝕂>
https://chat.whatsapp.com/DrGsubrdgnPILMqgj1iOOD
╔══╗
║██║
║(O)║♫ ♪ ♫ ♪
╚══╝
▄ █ ▄ █ ▄ ▄ █ ▄ █ ▄ █
Min- - - - - - - - - - - -●Max✾ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٖٖٜ۬ـٰٖٜ۬ـٰٖٜ۬ـٰٰٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٖٖٜ۬✾➣
...
//owner v card
global.vcardowner = ['+94779038058'] // owner number
global.ownername = "😎𝙆.𝙍𝘼𝙎𝙃𝙈𝙄𝙆𝘼❯❯" // owner name
global.ytname = "" /🙈𝙎𝙇 𝙍𝙐𝙎𝙃🙈/ yt chanel name
global.socialm = "GitHub: kaviduakash" // github or insta name
...
global.botname = '𝙍𝙀𝘿╺ 𝘿𝙍𝘼𝙂𝙊𝙉 - 𝙈𝘿 𝘽𝙊𝙏' //ur bot name
